...
class DividerItemDecorationRecyclerViewFragment : Fragment() {
    ...
    companion object {
        fun buildFragment(): DividerItemDecorationRecyclerViewFragment {
            return DividerItemDecorationRecyclerViewFragment()
        }
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_divideritemdecoraion_recyclerview_layout, container, false)
    }
